import hmtl from '../assets/logos/html.png';
...
export const TOPICS = [
  ...
  { name: 'CSS', route: '/Topics/Css', icon: css, bg: '' },
  { name: 'JavaScript', route: '/Topics/Js', icon: js, bg: '' },
  { name: 'React', route: '/Topics/React', icon: react, bg: '' },
